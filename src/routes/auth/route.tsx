...
// CUSTOMIZE: Change redirect, swap auth provider
function AuthPage() {
  const { signIn } = useAuthActions()

  return (
    <div className="bg-bg flex min-h-screen flex-col items-center justify-center px-5">
      <div className="flex flex-col items-center gap-7">
        <div className="flex flex-col items-center gap-2">
          <h1 className="font-display text-text-primary text-[32px] leading-[36px]">
            Sign in
          </h1>
          <p className="text-text-secondary font-body text-base leading-5">
